    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">
          Effortlessly create a stunning blog that reflects your unique voice.
          We provide the tools, you bring the passion. Grow your online presence
          and connect with readers who care.
        </p>
